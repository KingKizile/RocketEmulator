...
namespace Rocket.HabboHotel.Achievements
{
    public class AchievementManager
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.Achievements.AchievementManager");
        ...
        public AchievementManager()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando os dados de Achievement.");
        }
