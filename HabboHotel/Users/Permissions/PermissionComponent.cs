...
namespace Rocket.HabboHotel.Users.Permissions
{
    /// <summary>
    ...
    public sealed class PermissionComponent
    {
        ...
        public bool Init(Habbo Player)
        {
            ...
            this._permissions.AddRange(RocketEmulador.GetGame().GetPermissionManager().GetPermissionsForPlayer(Player));
            this._commands.AddRange(RocketEmulador.GetGame().GetPermissionManager().GetCommandsForPlayer(Player));
            return true;
        }
