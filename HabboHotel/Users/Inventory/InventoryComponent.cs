...
using Rocket.HabboHotel.Users.Inventory.Pets;
...
namespace Rocket.HabboHotel.Users.Inventory
{
    public class InventoryComponent
    {
        ...
        {
            return RocketEmulador.GetGame().GetClientManager().GetClientByUserID(_userId);
        }
