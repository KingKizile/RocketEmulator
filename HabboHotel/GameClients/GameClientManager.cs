...
namespace Rocket.HabboHotel.GameClients
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.GameClients.GameClientManager");
        ...
        public void DoAdvertisingReport(GameClient Reporter, GameClient Target)
        {
            ...
            Builder.Append("Novo reporte recebido!\r\r");
            Builder.Append("Reporte: " + Reporter.GetHabbo().Username + "\r");
            Builder.Append("Usuario reportado: " + Target.GetHabbo().Username + "\r\r");
            Builder.Append(Target.GetHabbo().Username + "s últimos 10 mensagens:\r\r");
        ...
        public void CloseAll()
        {
            foreach (GameClient client in this.GetClients.ToList())
            {
                ...
                if (client.GetHabbo() != null)
                {
                    try
                    {
                        ...
                        Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Desligando o servidor.");
                    }
                    catch
                    {
                    }
            ...
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Preparando tudo para desligar...");
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] => Aguarde, estamos salvando tudo.");
            try
            {
                foreach (GameClient client in this.GetClients.ToList())
                {
                    ...
                    Console.Clear();
                    Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Falta pouco, estamos fechando as conexões.");
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  As conexões foram encerradas.");
        }
