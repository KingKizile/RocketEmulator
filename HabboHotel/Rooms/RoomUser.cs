...
using Rocket.HabboHotel.Rooms.Games.Freeze;
...
namespace Rocket.HabboHotel.Rooms
{
    public class RoomUser
    {
        ...
        public string GetUsername()
        {
            ...
            if (GetClient() != null)
            {
                if (GetClient().GetHabbo() != null)
                {
                    ...
                    return RocketEmulador.GetUsernameById(HabboId);
        ...
        public bool IncrementAndCheckFlood(out int MuteTime)
        {
            ...
            if (ChatSpamTicks == -1)
                ChatSpamTicks = 8;
            else if (ChatSpamCount >= RocketEmulador.SpamUser)
            {
                ...
                GetClient().GetHabbo().FloodTime = RocketEmulador.GetUnixTimestamp() + MuteTime;

                ChatSpamCount = RocketEmulador.SpamUser;
                return true;
            }
            return false;
        }
        ...
        public void OnChat(int Colour, string Message, bool Shout)
        {
            ...
            if (Shout)
                Packet = new ShoutComposer(VirtualId, ColouredMessage, RocketEmulador.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
            else
                Packet = new ChatComposer(VirtualId, ColouredMessage, RocketEmulador.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
        ...
        public void SendNameColourPacket()
        {
            if (IsBot || GetClient() == null || GetClient().GetHabbo() == null)
                return;
            if (GetClient().GetHabbo().chatColour == null || GetClient().GetHabbo().chatColour == String.Empty)
                return;
            ...
            { string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.pro"] + "'><b>[PROGRAMADOR] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
            ...
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.ceo"] + "'><b>[CEO] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            if (GetClient().GetHabbo().Rank == 8)
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.ger"] + "'><b>[GERENTE] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.adm"] + "'><b>[ADMINISTRADOR] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.mod"] + "'><b>[MODERADOR] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            if (GetClient().GetHabbo().Rank == 5)
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.pde"] + "'><b>[PROMOTOR] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            if (GetClient().GetHabbo().Rank == 4)
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.amb"] + "'><b>[EMBAIXADOR] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            if (GetClient().GetHabbo().Rank == 3)
            {
                string username = "<font color= '"+ RocketEmulador.RocketData().data["mudarcor.loc"] +"'><b>[LOCUTOR] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
            ...
            if (GetClient().GetHabbo().Rank == 2)
            {
                string username = "<font color= '" + RocketEmulador.RocketData().data["mudarcor.vip"] + "'><b>[VIP] - </b></font>" + GetClient().GetHabbo().Username;
                if (GetRoom() != null)
                    GetRoom().SendMessage(new UserNameChangeComposer(RoomId, VirtualId, username));
        ...
        public GameClient GetClient()
        {
            ...
            if (mClient == null)
                mClient = RocketEmulador.GetGame().GetClientManager().GetClientByUserID(HabboId);
            return mClient;
        }
        ...
        {
            if (mRoom == null)
                if (RocketEmulador.GetGame().GetRoomManager().TryGetRoom(RoomId, out mRoom))
                    return mRoom;
    ...
    public static class ByteToItemEffectEnum
    {
        public static ItemEffectType Parse(byte pByte)
        {
            switch (pByte)
            {
                ...
                case 8:
                    return ItemEffectType.Skateboard;
