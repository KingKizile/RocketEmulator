...
using Rocket.Communication.Packets.Outgoing.Inventory.Trading;
    ...
    public class Trade
    {
        ...
        public void DeliverItems()
        {
            ...
            foreach (Item I in ItemsOne.ToList())
            {
                ...
                {
                    GetTradeUser(oneId).GetClient().SendNotification(RocketEmulador.GetGame().GetLanguageLocale().TryGetValue("trade_failed"));
                    GetTradeUser(twoId).GetClient().SendNotification(RocketEmulador.GetGame().GetLanguageLocale().TryGetValue("trade_failed"));
                    return;
                }
                User1 += I.Id + ";";
            }
