...
using Rocket.Communication.Packets.Outgoing.Rooms.Freeze;
using Rocket.HabboHotel.Rooms.Games.Teams;
using Rocket.HabboHotel.Items.Wired;

namespace Rocket.HabboHotel.Rooms.Games.Freeze
{
    public class Freeze
    {
        private Room _room;
        ...
        {
            return ExitTeleports.Values.ToList()[RocketEmulador.GetRandomNumber(0, ExitTeleports.Count - 1)];
        }
