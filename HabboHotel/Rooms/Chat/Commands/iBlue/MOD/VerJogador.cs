...
namespace Rocket.HabboHotel.Rooms.Chat.Commands.iBlue.MOD
{
    class VerJogador : IChatCommand
    {
        ...
        {
            get { return "Exiba informações de perfil de usuários"; }
        }
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            if (UserData == null)
            {
                Session.SendWhisper("Oops, there is no user in the database with that username (" + Username + ")!");
                return;
            }
            ...
            DateTime origin = new DateTime(2017, 1, 1, 0, 0, 0, 0).AddSeconds(Convert.ToDouble(UserInfo["trading_locked"]));
