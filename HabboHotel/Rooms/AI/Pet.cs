...
using Rocket.Communication.Packets.Outgoing.Pets;
...
namespace Rocket.HabboHotel.Rooms.AI
{
    public class Pet
    {
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = RocketEmulador.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (RocketEmulador.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((RocketEmulador.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return RocketEmulador.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
