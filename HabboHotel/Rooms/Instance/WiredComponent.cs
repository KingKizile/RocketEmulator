...
using Rocket.HabboHotel.Items.Wired.Boxes.Triggers;
using Rocket.HabboHotel.Items.Wired.Boxes.Effects;
using Rocket.HabboHotel.Items.Wired.Boxes.Conditions;
using Rocket.HabboHotel.Items.Wired.Boxes.Add_ons;

using Rocket.Database.Interfaces;
using System.Drawing;

namespace Rocket.HabboHotel.Rooms.Instance
{
    public class WiredComponent
    {
        ...
        public IWiredItem GenerateNewBox(Item Item)
        {
            switch (Item.GetBaseItem().WiredType)
            {
                ...
                case WiredBoxType.MuteTriggererBox:
                ...
                case WiredBoxType.ConditionFurniHasNoFurni:
                    return new FurniHasNoFurniBox(_room, Item);*/
                case WiredBoxType.SetDanceUserBox:
                    return new SetDanceUserBox(this._room, Item);
                case WiredBoxType.GiveUserCreditsBox:
                    return new GiveUserCreditsBox(this._room, Item);
                case WiredBoxType.GiveUserDucketsBox:
                    return new GiveUserDucketsBox(this._room, Item);
                case WiredBoxType.HandUserItemBox:
                    return new HandUserItemBox(this._room, Item);
                case WiredBoxType.SetFreezeUserBox:
                    return new SetFreezeUserBox(this._room, Item);
                case WiredBoxType.SetFixRoomBox:
                    return new SetFixRoomBox(this._room, Item);
                case WiredBoxType.SetFastWalkUserBox:
                    return new SetFastWalkUserBox(this._room, Item);
