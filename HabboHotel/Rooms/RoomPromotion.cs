...
namespace Rocket.HabboHotel.Rooms
{
    public class RoomPromotion
    {
        ...
        public RoomPromotion(string Name, string Desc, int CategoryId)
        {
            ...
            this._timestampStarted = RocketEmulador.GetUnixTimestamp();
            this._timestampExpires = (RocketEmulador.GetUnixTimestamp()) + (RocketGame.RoomPromotionLifeTime * 60);
        ...
        {
            get { return (this.TimestampExpires - RocketEmulador.GetUnixTimestamp()) < 0; }
        }

        public int MinutesLeft
        {
            get { return Convert.ToInt32(Math.Ceiling((this.TimestampExpires - RocketEmulador.GetUnixTimestamp()) / 60)); }
        }
