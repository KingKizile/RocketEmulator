...
namespace Rocket.HabboHotel.Permissions
{
    public sealed class PermissionManager
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.Permissions.PermissionManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando " + this.Permissions.Count + " permissões.");
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando " + this.PermissionGroups.Count + " permissões de grupo.");
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando " + this.PermissionGroupRights.Count + " permissões de direitos.");
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando " + this.PermissionSubscriptionRights.Count + " permissões de sub direitos.");
        }
