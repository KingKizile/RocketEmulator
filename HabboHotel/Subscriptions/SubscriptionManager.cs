...
namespace Rocket.HabboHotel.Subscriptions
{
    public class SubscriptionManager
    {
        private static ILog log = LogManager.GetLogger("Rocket.HabboHotel.Subscriptions.SubscriptionManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando " + this._subscriptions.Count + " permissões de subscription.");
