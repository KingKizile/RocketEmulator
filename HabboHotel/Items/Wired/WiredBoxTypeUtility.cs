    ...
    static class WiredBoxTypeUtility
    {
        public static WiredBoxType FromWiredId(int Id)
        {
            switch (Id)
            {
                ...
                case 63:
                    return WiredBoxType.ConditionActorIsNoInTeamBox;
                case 64:
                    return WiredBoxType.EffectAddScore;
                case 65:
                    return WiredBoxType.SetEnableUserBox;
                case 66:
                    return WiredBoxType.GiveUserCreditsBox;
                case 67:
                    return WiredBoxType.GiveUserDucketsBox;
                case 68:
                    return WiredBoxType.HandUserItemBox;
                case 69:
                    return WiredBoxType.SetFreezeUserBox;
                case 70:
                    return WiredBoxType.SetFixRoomBox;
                case 71:
                    return WiredBoxType.SetFastWalkUserBox;
                case 72:
                    return WiredBoxType.SetDanceUserBox;
                case 73:
                    return WiredBoxType.MuteTriggererBox;
            }
        }
        ...
        public static int GetWiredId(WiredBoxType Type)
        {
            switch (Type)
            {
                ...
                case WiredBoxType.ConditionActorIsNoInTeamBox:
                ...
                case WiredBoxType.ActionGiveScore:
                    return 28;
            }
            return 0;
        }
