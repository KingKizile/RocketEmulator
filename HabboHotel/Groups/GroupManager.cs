...
namespace Rocket.HabboHotel.Groups
{
    public class GroupManager
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.Groups.GroupManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Grupos carregados com sucesso.");
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Forums de Grupos carregados com sucesso.");
        }
