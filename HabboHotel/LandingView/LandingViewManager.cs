...
namespace Rocket.HabboHotel.LandingView
{
    public class LandingViewManager
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.LandingView.LandingViewManager");
        ...
        public void LoadPromotions()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando a tela inicial.");
        }
