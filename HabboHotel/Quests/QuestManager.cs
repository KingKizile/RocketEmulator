...
namespace Rocket.HabboHotel.Quests
{
    public class QuestManager
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.Quests.QuestManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando as configurações de missões.");
        }
