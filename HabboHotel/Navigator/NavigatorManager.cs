...
namespace Rocket.HabboHotel.Navigator
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.HabboHotel.Navigator.NavigatorManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Carregando o navegador.");
        }
