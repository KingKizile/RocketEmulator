...
using Rocket.Communication.Packets.Incoming.Catalog;
using Rocket.Communication.Packets.Incoming.Handshake;
using Rocket.Communication.Packets.Incoming.Navigator;
using Rocket.Communication.Packets.Incoming.Quests;
using Rocket.Communication.Packets.Incoming.Rooms.Avatar;
using Rocket.Communication.Packets.Incoming.Rooms.Chat;
using Rocket.Communication.Packets.Incoming.Rooms.Connection;
using Rocket.Communication.Packets.Incoming.Rooms.Engine;
using Rocket.Communication.Packets.Incoming.Rooms.Action;
using Rocket.Communication.Packets.Incoming.Users;
using Rocket.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Rocket.Communication.Packets.Incoming.Inventory.Purse;
using Rocket.Communication.Packets.Incoming.Sound;
using Rocket.Communication.Packets.Incoming.Misc;
using Rocket.Communication.Packets.Incoming.Inventory.Badges;
using Rocket.Communication.Packets.Incoming.Avatar;
using Rocket.Communication.Packets.Incoming.Inventory.Achievements;
using Rocket.Communication.Packets.Incoming.Inventory.Bots;
using Rocket.Communication.Packets.Incoming.Inventory.Pets;
using Rocket.Communication.Packets.Incoming.LandingView;
using Rocket.Communication.Packets.Incoming.Messenger;
using Rocket.Communication.Packets.Incoming.Groups;
//using Rocket.Communication.Packets.Incoming.Nucs;

using Rocket.Communication.Packets.Incoming.Rooms.Settings;
using Rocket.Communication.Packets.Incoming.Rooms.AI.Pets;
using Rocket.Communication.Packets.Incoming.Rooms.AI.Bots;
using Rocket.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Rocket.Communication.Packets.Incoming.Rooms.Furni;
using Rocket.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Rocket.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Rocket.Communication.Packets.Incoming.Help;
using Rocket.Communication.Packets.Incoming.Rooms.FloorPlan;
using Rocket.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Rocket.Communication.Packets.Incoming.Moderation;
using Rocket.Communication.Packets.Incoming.Inventory.Furni;
using Rocket.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Rocket.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Rocket.Communication.Packets.Incoming.Inventory.Trading;
using Rocket.Communication.Packets.Incoming.GameCenter;
using Rocket.Communication.Packets.Incoming.Marketplace;
using Rocket.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Rocket.Communication.Packets.Incoming.Talents;
using Rocket.Communication.Packets.Incoming.Rooms.Camera;
using Rocket.Communication.Packets.Incoming.Quiz;
using Rocket.Communication.Packets.Incoming.Rooms.Polls;

namespace Rocket.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.Communication.Packets");
        ...
        {
            this._incomingPackets.Add(ClientPacketHeader.AcceptPollQuestiosMessageEvent, new AcceptPollQuestionsEvent());
            this._incomingPackets.Add(ClientPacketHeader.DeclinePollQuestionsMessageEvent, new DeclinePollQuestionsEvent());
            this._incomingPackets.Add(ClientPacketHeader.AnswerPollQuestionMessageEvent, new AnswerPollQuestionEvent());
        }
