...
namespace Rocket.Communication.Packets.Outgoing.Marketplace
{
    class MarketplaceItemStatsComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.MarketplaceItemStatsMessageComposer)
        {
            ...
            base.WriteInteger(RocketEmulador.GetGame().GetCatalog().GetMarketplace().OfferCountForSprite(SpriteId));
