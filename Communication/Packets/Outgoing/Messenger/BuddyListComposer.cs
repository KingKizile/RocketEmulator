...
namespace Rocket.Communication.Packets.Outgoing.Messenger
{
    class BuddyListComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.BuddyListMessageComposer)
        {
            ...
            {
               /* if (Friend.Id == 1000000005)
                {
                    base.WriteInteger(1000000005);
                ...
                if (Friend.Id == 1000000004)
                {
                    base.WriteInteger(1000000004);
                    base.WriteString(Friend.mUsername);
                    base.WriteInteger(1);//Gender.
                    base.WriteBoolean(true);
                    base.WriteBoolean(Friend.InRoom);
               ...
               if (Friend.Id == 1000000003)
                {
                    base.WriteInteger(1000000003);
                    base.WriteString(Friend.mUsername);
                    base.WriteInteger(1);//Gender.
                    base.WriteBoolean(true);
                    base.WriteBoolean(Friend.InRoom);
                ...
                if (Friend.Id == 1000000002)
                {
                    base.WriteInteger(1000000002);
                    base.WriteString(Friend.mUsername);
                    base.WriteInteger(1);//Gender.
                    base.WriteBoolean(true);
                    base.WriteBoolean(Friend.InRoom);
                    ...
                    if (Friend.Id == 1000000001)
                {
                    base.WriteInteger(1000000001);
                    base.WriteString(Friend.mUsername);
                    base.WriteInteger(1);//Gender.
                    base.WriteBoolean(true);
                    base.WriteBoolean(Friend.InRoom);
