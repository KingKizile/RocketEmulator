...
namespace Rocket.Communication.Packets.Outgoing.Quests
{
    class QuestStartedComposer : ServerPacket
    {
        ...
        private void SerializeQuest(ServerPacket Message, GameClient Session, Quest Quest, string Category)
        {
            ...
            Message.WriteInteger(Quest == null ? 10 : Quest.GoalData); // Target progress
            Message.WriteInteger(Quest == null ? 1110 : Quest.TimeUnlock); // "Next quest available countdown" in seconds
            Message.WriteString("");
            Message.WriteString("");
