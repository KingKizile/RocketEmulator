...
namespace Rocket.Communication.Packets.Incoming.Rooms.AI.Pets
{
    class PlacePetEvent : IPacketEvent
    {
        private static readonly ILog log = LogManager.GetLogger("Rocket.Communication.Packets.Incoming.Rooms.AI.Pets.PlacePetEvent");
        ...
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Room.GetRoomUserManager().PetCount > RocketGame.RoomPetPlacementLimit)
            {
