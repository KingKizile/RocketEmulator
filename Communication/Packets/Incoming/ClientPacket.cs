...
namespace Rocket.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (RocketEmulador.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return RocketEmulador.GetDefaultEncoding().GetString(ReadFixedValue());
        }
