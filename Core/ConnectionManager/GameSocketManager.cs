...
namespace ConnectionManager
{
    public class SocketManager
    {
        ...
        public void init(int portID, int maxConnections, int connectionsPerIP, IDataParser parser,  bool disableNaglesAlgorithm)
        {
            ...
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  O servidor foi ligado com sucesso na porta ("+ portID + ".");
            Console.WriteLine("       [FUNCIONANDO] => [Rocket Emu] =>  Conexões máximas por ip são de (" + connectionsPerIP + ".");
