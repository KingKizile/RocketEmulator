...
namespace Rocket.Messages.Net
{
    ...
    public class MusConnection
    {
        ...
        private static readonly ILog log = LogManager.GetLogger("Rocket.Messages.Net.MusConnection");
                ...
                case "reload_credits":
                    {
                        ...
                        Client = RocketEmulador.GetGame().GetClientManager().GetClientByUserID(UserId);
                ...
                case "disconnect":
                    {
                        try
                        {
                            GameClient TargetClient = RocketEmulador.GetGame().GetClientManager().GetClientByUserID(Convert.ToInt32(Params[0]));
                ...
                case "goto":
                    {
                        ...
                        {
                            Room _room = RocketEmulador.GetGame().GetRoomManager().LoadRoom(RoomId);
                            if (_room == null)
                ...
                case "progress_achievement":
                    {
                        ...
                        RocketEmulador.GetGame().GetAchievementManager().ProgressAchievement(Client, Achievement, Progress);
                        break;
                    }
                #endregion
                #endregion
                ...
                case "refresh_ranks":
                    {
                        ...
                        foreach (GameClient C in RocketEmulador.GetGame().GetClientManager().GetClients.ToList())
                        {
    ...
    case "add_preview":
                        ...
                        RocketEmulador.GetGame().GetCameraManager().AddPreview(new CameraPhotoPreview(PhotoId, UserId, CreatedAt));
                                    break;
                                }
